	...
	<div class="row justify-content-center my-5">
		<div class="col-md-8">
			...
			<div class="card">
				...
				<div class="card-body">
					<form action="<?= base_url('index.php/cekKonfirmasiPesawat') ?>" method="POST">						
						
						<div class="form-group">
							<label>Kode Booking</label>
							<input type="text" class="form-control" placeholder="Kode Booking" name="kode" required>
						</div>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="table-responsive">
							...
							<tbody>
								...
								<div class="modal fade" id="gantiGerbong<?= $dt->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										...
										<form action="<?= base_url('index.php/PilihGerbongPesawat') ?>" method="post">
						...
						<?= form_open_multipart("index.php/kirimKonfirmasiPesawat"); ?>
